...
#       temporary files rather than seli directory.
#
#   (2) You need a Java installation to run Gradle. Define JAVA_HOME
#       for the location of your Java installation.
#
##############################################################################
...
# Stop when "xeli" or "xereli" is enabled.
